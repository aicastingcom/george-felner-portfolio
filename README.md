...
**Videos** are not in Git (too large). Upload them to Hostinger `public_html/videos/` with folders: `cinema`, `ai`, `advertising`, `corporate`, `corporate-extra`, `social`, `webseries`.
